return {
  {
    ...
    config = function()
      ...
      require("plugins.lsp.css_ls")
      require("plugins.lsp.docker_ls")
      require("plugins.lsp.graphql_ls")
      require("plugins.lsp.html_ls")
      require("plugins.lsp.json_ls")
      require("plugins.lsp.vue_ls")
  ...
  },
  {
    ...
    config = function()
      require("plugins.lsp.typescript_ls")
    end,
  },
  {
    "zk-org/zk-nvim",
