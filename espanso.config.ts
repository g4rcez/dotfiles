...
export default createEspansoConfig({
    ...
    const shellTriggers = [
        ...
        espanso.shell("cvvmaster", "Generate valid CVV for mastercard", runMain("card --brand=master --cvv")),
        espanso.shell("visa", "Generate valid visacard number", runMain("card --brand=visa")),
        espanso.shell("cvvvisa", "Generate valid CVV visacard", runMain("card --brand=visa --cvv")),
        espanso.shell("amex", "Generate valid amexcard number", runMain("card --brand=amex")),
        espanso.shell("cvvamex", "Generate valid CVV amexcard", runMain("card --brand=amex --cvv")),
