...
function M.get_status() return M.in_window_mode end

function M.enter_window_mode()
  if M.in_window_mode then return end
...
function M.reset_timer()
  ...
  M.timer = vim.defer_fn(function() M.exit_window_mode() end, M.timeout)
end
...
function M.create_window_mappings()
  ...
  for key, config in pairs(window_commands) do
    ...
    if original_map and original_map.lhs then M.original_mappings[key] = original_map end
    ...
    vim.keymap.set("n", key, function()
      ...
      if config.exit then M.exit_window_mode() end
...
function M.setup(opts)
  ...
  vim.api.nvim_create_user_command(
    "WindowModeStatus",
    function() print("Window mode: " .. (M.in_window_mode and "ON" or "OFF")) end,
    {}
  )

  vim.api.nvim_create_user_command("WindowModeExit", function() M.exit_window_mode() end, {})
end
